...
class Graph:
    ...
    def bft(self, starting_vertex):
        ...
        """
        # Search all around first layer, then proceed to next layer.
    ...
    def dft(self, starting_vertex):
        ...
        beginning from starting_vertex.
        """
        # 1. do one of 1st layer, then one of 2nd layer, then go back to start
    ...
    def bfs(self, starting_vertex, destination_vertex):
        ...
        while q.size() > 0:
        # dequeue the node at the fornt of line
